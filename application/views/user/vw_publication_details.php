...
<!---------------- Login/Logout Button Ends ------------!-->
      ...
      </div>    <!-- MAIN PART STARTS -->

<div class="col-sm-6 main">
    <h2><i class="fa fa-users" aria-hidden="true"></i> Publications Details</h2>

    <div class="container">
        <?php
        foreach ($select_publication as $value){
        // j=01(date),l=(day),g=(hour),i=(minute) a=(am/pm)

        $date = strtotime($value->publication_date);
        ...
        ?>
        <h3 style="color:#2aa6ca;"><?php echo $value->publication_title;?></h3>
        <table class="table table-striped table-bordered table-hover table-condensed">
            ...
            <tr>
                ...
                <td><?php echo $value_cat->category_name;?></td>
            </tr>
           <?php
            }
            ?>
            <tr>
                ...
                <td><?php echo $value->publication_type;?></td>
            </tr>
            ...
            <tr>
                <th>Author:</th>
                <td><?php echo $value->publication_author;?></td>
            </tr>

            <tr>
                <th>Language</th>
                <td><?php echo $value->publication_language;?></td>
            </tr>
            <tr>
            ...
            <tr>
                <th>ISBN-13:</th>
                <td><?php echo $value->publication_isbn_13;?></td>
            </tr>
            <tr>
                <th>Book Title:</th>
                <td><?php echo $value->publication_book_title;?></td>
            </tr>
            <tr>
                <th>Summary:</th>
                <td><?php echo $value->publication_summary;?>
                </td>
            </tr>
            <tr>
                <th>Additional Information</th>
                <td><?php echo $value->publication_additional_information;?></td>
            </tr>
    ...
    {
     ?>
        <a href="<?php echo base_url().$value->publication_file;?>" onclick="return confirm('Do you want to download or open the publication file?');" id="name"><button class = "btn btn-info">Read or Download</button></a>
...
researcher_login"  id="name"><button class = "btn btn-info">Read or Download</button></a>
            <?php
    }
    }
    ?>
