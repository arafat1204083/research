...
<!---------------- Login/Logout Button Ends ------------!-->
	...
	<div class="col-sm-6 main">
			<h3><i class="fa fa-user-md" aria-hidden="true"></i> Meet our Researchers</h3>
			<p>Meet our all researchers. Click on their names in order to get their full details.</p><br>
		<div class="row">
			<div class="col-sm-12">
			...
			<?php
			 ...
			 foreach ($select_researcher as $value) { ?>
				<div class="row" >
				 <div class="col-sm-3">
							<?php if($value->researcher_photo==1){
								?>
							<img src="<?php echo base_url()."asset/pro.gif"; ?>" class="img-circle img-responsive">
							<?php
							}
							else{
								?>
							<img src="<?php echo base_url().$value->researcher_photo; ?>" class="img-circle img-responsive">
							<?php
							}
							?>
						</div>
						<div class="col-sm-9">
							<a href="<?php echo base_url().'user/researcher_by_id/'.$value->researcher_id; ?>"><h4><?php echo $value->researcher_name;?></h4></a>
							<p><?php echo $value->researcher_bio;?></p>
						</div>
				</div>
				<br>
			<?php } ?>
