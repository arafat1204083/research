...
<!---------------- Login/Logout Button Ends ------------!-->
    ...
    <div class="col-sm-6 main">
        <h3><i class="glyphicon glyphicon-book" aria-hidden="true"></i> Publications</h3><br>
        <ul class="event-list">
            <?php
            ...
            foreach ($select_publication as $value):
                ...
                ?>
                <li><a href="<?php echo base_url();?>user/publication_details/<?php echo $value['publication_id'];?>"><h4><b> <?php echo $value['publication_title']; ?></b></h4></a>

                    <label>Author: </label> <?php echo $value['publication_author']; ?><br>
        
                    <label>Type: </label> <?php echo $value['publication_type']; ?><br>
    ...
    <div class="col-sm-3 extra-right">
        <div class="search">
            ...
            <div class="input-group">
                <input type="text" class="form-control" placeholder="Publication/Authors" name="search_value" id="srch-term">
                ...
                for($i = $year;$i>=2014;$i--){
                    ...
                    <ul id="demo<?php echo $i;?>" class="collapse">
                        ...
                        for ($month=1; $month <=12 ; $month++) {
                            ...
                            ?>
                            <li><a href="<?php echo base_url()?>user/publication_archieve/<?php echo $i;?>/<?php echo $month;?>"><i class="fa fa-user" aria-hidden="true"></i> <?php echo $month_name?> </a></li>
                            <?php
                            if($i==$year && $month==$m)
                                break;
