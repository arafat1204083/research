			  		...
			  		<div class="col-sm-7">
						...
						<div class="row">
							<div class="col-sm-11 form-group">
								<input class="form-control" type="date" id="datepicker" required="required"  name="timeline_start_date" placeholder="Activity Starting Date">
							</div>
						</div>
						<div class="row">
							<div class="col-sm-11 form-group">
						...
						<?php
						foreach ($select_timeline_by_id as $value) 
						{
							 echo form_open_multipart(base_url().'admin/update_timeline/'.$value->timeline_id);

						?>
						<div class="row">
							<div class="col-sm-11 form-group">
								<input class="form-control" type="date" id="timeline_start_date" required="required"  name="timeline_start_date" value="<?php echo $value->timeline_start_date; ?>" placeholder="Activity Starting Date">
							</div>
						</div>	
						
						<div class="row">
							<div class="col-sm-11 form-group">
								<textarea class="form-control" required="required" type="text" id="name" name="timeline_activity" placeholder="Project Activity"><?php echo $value->timeline_activity; ?></textarea>		
							</div>
						</div>
						<div class="row">
							<div class="col-sm-11 form-group">
