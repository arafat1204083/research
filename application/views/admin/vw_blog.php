...
<div class="col-xs-10 content">
    ...
    ?>
    <div class="cat">
        <h3><i class="fa fa-globe" aria-hidden="true"></i>Publish a Blog :</h3><br>
        <div class="row">
            <div class="col-sm-8" style="padding-right:25px;">
                <div class="row">
                    ...
                    <?php
                    echo form_open_multipart(base_url().'admin/insert_blog');
                    ?>
                    <div class="col-sm-9 form-group">
                        <input class="form-control" id="name" name="blog_headline" placeholder="Headline" type="text" required>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 form-group">
                     <textarea  class="form-control" id="name" name="blog_text" value="" placeholder="Content" type="text"  rows="6" required></textarea><br>
